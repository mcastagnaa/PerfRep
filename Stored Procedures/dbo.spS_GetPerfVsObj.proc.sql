...
IF  EXISTS (
	...
	WHERE 	id = OBJECT_ID(N'dbo.spS_GetPerfVsObj') AND 
		OBJECTPROPERTY(id,N'IsProcedure') = 1
	)
DROP PROCEDURE dbo.spS_GetPerfVsObj
GO

CREATE PROCEDURE dbo.spS_GetPerfVsObj
	@RefDate datetime
	, @Filter integer
	, @Company nvarchar(50)
	, @Desk nvarchar(50)
...
SELECT	Fset.Id AS FundId
	...
	, Fset.PrimaryObj 
	, (CASE Fset.PrimaryObj
		WHEN 'Peer' THEN
			(CASE WHEN NP1m IS NULL OR PGmed_r1m IS NULL THEN NULL
			WHEN NP1m > PGmed_r1m THEN 1 
			ELSE 0 END)
		WHEN  'Index' THEN
			(CASE WHEN NP1m IS NULL OR Ben1m IS NULL THEN NULL
			WHEN NP1m > Ben1m THEN 1 
			ELSE 0 END)
		ELSE null END) AS Ahead1m
	, (CASE Fset.PrimaryObj
		WHEN 'Peer' THEN
			(CASE WHEN NP3m IS NULL OR PGmed_r3m IS NULL THEN NULL
			WHEN NP3m > PGmed_r3m THEN 1 
			ELSE 0 END)
		WHEN  'Index' THEN
			(CASE WHEN NP3m IS NULL OR Ben3m IS NULL THEN NULL
			WHEN NP3m > Ben3m THEN 1 
			ELSE 0 END)
		ELSE null END) AS Ahead3m
	, (CASE Fset.PrimaryObj
		WHEN 'Peer' THEN
			(CASE WHEN NP6m IS NULL OR PGmed_r6m IS NULL THEN NULL
			WHEN NP6m > PGmed_r6m THEN 1 
			ELSE 0 END)
		WHEN  'Index' THEN
			(CASE WHEN NP6m IS NULL OR Ben6m IS NULL THEN NULL
			WHEN NP6m > Ben6m THEN 1 
			ELSE 0 END)
		ELSE null END) AS Ahead6m
	, (CASE Fset.PrimaryObj
		WHEN 'Peer' THEN
			(CASE WHEN NP1y IS NULL OR PGmed_r1y IS NULL THEN NULL
			WHEN NP1y > PGmed_r1y THEN 1 
			ELSE 0 END)
		WHEN  'Index' THEN
			(CASE WHEN NP1y IS NULL OR Ben1y IS NULL THEN NULL
			WHEN NP1y > Ben1y THEN 1 
			ELSE 0 END)
		ELSE null END) AS Ahead1y
	, (CASE Fset.PrimaryObj
		WHEN 'Peer' THEN
			(CASE WHEN NP2y IS NULL OR PGmed_r2y IS NULL THEN NULL
			WHEN NP2y > PGmed_r2y THEN 1 
			ELSE 0 END)
		WHEN  'Index' THEN
			(CASE WHEN NP2y IS NULL OR Ben2y IS NULL THEN NULL
			WHEN NP2y > Ben2y THEN 1 
			ELSE 0 END)
		ELSE null END) AS Ahead2y
	, (CASE Fset.PrimaryObj
		WHEN 'Peer' THEN
			(CASE WHEN NP3y IS NULL OR PGmed_r3y IS NULL THEN NULL
			WHEN NP3y > PGmed_r3y THEN 1 
			ELSE 0 END)
		WHEN  'Index' THEN
			(CASE WHEN NP3y IS NULL OR Ben3y IS NULL THEN NULL
			WHEN NP3y > Ben3y THEN 1 
			ELSE 0 END)
		ELSE null END) AS Ahead3y
	, (CASE Fset.PrimaryObj
		WHEN 'Peer' THEN
			(CASE WHEN NP5y IS NULL OR PGmed_r5y IS NULL THEN NULL
			WHEN NP5y > PGmed_r5y THEN 1 
			ELSE 0 END)
		WHEN  'Index' THEN
			(CASE WHEN NP5y IS NULL OR Ben5y IS NULL THEN NULL
			WHEN NP5y > Ben5y THEN 1 
			ELSE 0 END)
		ELSE null END) AS Ahead5y
	, (CASE Fset.PrimaryObj
		WHEN 'Peer' THEN
			(CASE WHEN NPYtD IS NULL OR PGmed_rYtD IS NULL THEN NULL
			WHEN NPYtD > PGmed_rYtD THEN 1 
			ELSE 0 END)
		WHEN  'Index' THEN
			(CASE WHEN NPYtD IS NULL OR BenYtD IS NULL THEN NULL
			WHEN NPYtD > BenYtD THEN 1 
			ELSE 0 END)
		ELSE null END) AS AheadYtD
	, (CASE Fset.PrimaryObj
		WHEN 'Peer' THEN
			(CASE WHEN NPEo2y_TD IS NULL OR PGmed_rEo2y_TD IS NULL THEN NULL
			WHEN NPEo2y_TD > PGmed_rEo2y_TD THEN 1 
			ELSE 0 END)
		WHEN  'Index' THEN
			(CASE WHEN NPEo2y_TD IS NULL OR BenEo2y_TD IS NULL THEN NULL
			WHEN NPEo2y_TD > BenEo2y_TD THEN 1 
			ELSE 0 END)
		ELSE null END) AS AheadEo2y_TD
	, (CASE Fset.PrimaryObj
		WHEN 'Peer' THEN
			(CASE WHEN NPEo3y_TD IS NULL OR PGmed_rEo3y_TD IS NULL THEN NULL
			WHEN NPEo3y_TD > PGmed_rEo3y_TD THEN 1 
			ELSE 0 END)
		WHEN  'Index' THEN
			(CASE WHEN NPEo3y_TD IS NULL OR BenEo3y_TD IS NULL THEN NULL
			WHEN NPEo3y_TD > BenEo3y_TD THEN 1 
			ELSE 0 END)
		ELSE null END) AS AheadEo3y_TD
	, (CASE Fset.PrimaryObj
		WHEN 'Peer' THEN
			(CASE WHEN NP_SI IS NULL OR PGmed_r_SI IS NULL THEN NULL
			WHEN NP_SI > PGmed_r_SI THEN 1 
			ELSE 0 END)
		WHEN  'Index' THEN
			(CASE WHEN NP_SI IS NULL OR Ben_SI IS NULL THEN NULL
			WHEN NP_SI > Ben_SI THEN 1 
			ELSE 0 END)
		ELSE null END) AS AheadSI
...
GRANT EXECUTE ON spS_GetPerfVsObj TO [OMAM\Compliance]
