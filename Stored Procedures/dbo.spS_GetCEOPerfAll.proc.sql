...
IF  EXISTS (
	...
	WHERE 	id = OBJECT_ID(N'dbo.spS_GetCEOPerfAll') AND 
		OBJECTPROPERTY(id,N'IsProcedure') = 1
	)
DROP PROCEDURE dbo.spS_GetCEOPerfAll
GO
...
SELECT	ISNULL(L.Item, P.Item) AS Item
	...
	, ISNULL(L.DeskGroup, P.DeskGroup) AS DeskGroup
...
------------------------------------------------
GO
GRANT EXECUTE ON dbo.spS_GetCEOPerfAll TO [OMAM\Compliance]
