...
IF  EXISTS (
	...
	WHERE 	id = OBJECT_ID(N'dbo.spS_GetFundsListForRawDataSLMC') AND 
		OBJECTPROPERTY(id,N'IsProcedure') = 1
	)
DROP PROCEDURE dbo.spS_GetFundsListForRawDataSLMC
GO

CREATE PROCEDURE dbo.spS_GetFundsListForRawDataSLMC
	@RefDate	datetime, 
	@Obj		nvarchar(50)	
...
----------------------------------------------------------------------------------
GRANT EXECUTE ON dbo.spS_GetFundsListForRawDataSLMC TO [OMAM\Compliance]